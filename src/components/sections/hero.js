...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Erwin Quek.</h2>;
  const three = <h3 className="big-heading">I build things as a hobby.</h3>;
  const four = (
    <>
      <p>
        I’m a Year 3 Computer Science student at National Univeristy Singapore. I will be 
